...
if(location.pathname.startsWith('/prop')){
  import('./prop-manual.js');
  if(location.pathname.replace(/\/$/,'')==='/prop')import('./prop-library-pagination.js');
}
if(/^\/baseball\/players\/\d+/.test(location.pathname))import('./baseball-player-export.js');
if(location.pathname.startsWith('/admin'))import('./baseball-admin-patch.js');
