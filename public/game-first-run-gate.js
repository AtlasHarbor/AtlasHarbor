(()=>{
 ...
 function loadCommandExperience(){loadModule('/game-command-loop-v2.js','gameCommandLoopV2');loadModule('/game-entity-interactions-v2.js','gameEntityInteractionsV2');loadModule('/game-career-loop-v2.js','gameCareerLoopV2');loadModule('/game-rebase-v3.js','gameRebaseV3')}
